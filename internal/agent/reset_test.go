...
func TestResetFlow(t *testing.T) {
	...
	t.Run("session clears current channel", func(t *testing.T) {
	...
	t.Run("session word alias", func(t *testing.T) {
	...
	t.Run("memories requires confirmation", func(t *testing.T) {
	...
	t.Run("project requires confirmation and returns reset requested", func(t *testing.T) {
		resetCalled := false
	...
	t.Run("everything requires confirmation and returns reset requested", func(t *testing.T) {
		resetCalled := false
	...
	t.Run("cancel from menu", func(t *testing.T) {
		resetCalled := false
	...
	t.Run("cancel word from menu", func(t *testing.T) {
		resetCalled := false
	...
	t.Run("deny confirmation", func(t *testing.T) {
		resetCalled := false
	...
	t.Run("on reset error", func(t *testing.T) {
		opts := Options{
			OnReset: func(level ResetLevel) error {
	...
	t.Run("nil on reset", func(t *testing.T) {
	...
	t.Run("stop cancels reset flow", func(t *testing.T) {
		resetCalled := false
...
func TestResetConfirmPrompt(t *testing.T) {
	t.Run("memories describes sharing", func(t *testing.T) {
	...
	t.Run("project describes all channels", func(t *testing.T) {
	...
	t.Run("everything lists all data", func(t *testing.T) {
...
func TestResetMenuPrompt(t *testing.T) {
	t.Run("describes per channel vs shared", func(t *testing.T) {
	...
	t.Run("HTML markup", func(t *testing.T) {
