...
func TestSanitizeHTML(t *testing.T) {
	tests := []struct {
		...
		{"real world: tool result with path", "<blockquote expandable>🔧 Reading /data/tclaw/alice/home/.claude/settings.json\n✅ Tool result (143 chars)\n</blockquote>", "<blockquote expandable>🔧 Reading /data/tclaw/alice/home/.claude/settings.json\n✅ Tool result (143 chars)\n</blockquote>"},
	}
