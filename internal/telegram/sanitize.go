...
// MarkdownToHTML converts the common markdown in a status message into Telegram HTML, and
// escapes HTML-like tags Telegram doesn't support so they don't cause parse errors.
