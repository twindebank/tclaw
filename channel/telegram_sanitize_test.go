...
func TestSanitizeTelegramHTML(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input:    "<blockquote expandable>🔧 Reading /data/tclaw/alice/home/.claude/settings.json\n✅ Tool result (143 chars)\n</blockquote>",
			expected: "<blockquote expandable>🔧 Reading /data/tclaw/alice/home/.claude/settings.json\n✅ Tool result (143 chars)\n</blockquote>",
		},
	}
